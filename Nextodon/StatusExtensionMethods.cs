...
{
    public static Grpc.Statuses ToGrpc(this IEnumerable<Nextodon.Data.Status>? i, Data.Account account, string domain)
    {
        ...
        if (i != null)
        {
            foreach (var r in i)
            {
                statuses.Data.Add(r.ToGrpc(account, domain));
            }
        }
